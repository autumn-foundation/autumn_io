...
description = "Wizards are session-backed multi-step forms where each step is validated independently before the user advances. The final \"commit\" step assembles all validated step data and performs the real write."
order = 350
+++
