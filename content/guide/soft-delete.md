+++
title = "Soft Delete"
description = "Soft delete lets you mark records as deleted (by stamping a deleted_at timestamp) rather than removing rows from the database. Deleted rows are hidden from all default finders but can be restored or permanently purged later."
order = 390
+++
