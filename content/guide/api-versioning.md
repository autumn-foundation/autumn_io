+++
title = "API Versioning, Deprecations, and Sunset Lifecycles"
description = "Autumn provides first-class support for managing API version lifecycles. By defining version lifecycles and tagging routes, Autumn handles RFC 9745 Deprecation and Sunset headers, automatic 410 Gone responses, OpenAPI spec grouping, and CI route auditing out-of-the-box."
order = 520
+++
