+++
title = "Step-Up Authentication (Sudo Mode)"
description = "#[secured] answers \"is the user logged in?\" — it ensures a valid session exists but makes no claim about how recently the user proved their identity. #[step_up] answers a stricter question: \"did the user re-prove their identity within the last N minutes?\""
order = 460
+++
