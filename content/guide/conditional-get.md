+++
title = "Conditional GET and ETags"
description = "Autumn ships first-class helpers for HTTP conditional GET — the mechanism that lets clients skip re-downloading content they already have cached. This is the missing companion to #[cached]: server-side caching short-circuits the render path; conditional GET short-circuits the network path."
order = 320
+++
