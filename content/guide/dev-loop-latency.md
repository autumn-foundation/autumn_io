+++
title = "Dev-Loop Latency Budget"
description = "Autumn's product promise is that the edit–refresh loop feels boringly fast. This document defines the accepted latency budget for every change class that autumn dev handles, explains how to measure it, and describes the gates that prevent regressions from shipping undetected."
order = 670
+++
