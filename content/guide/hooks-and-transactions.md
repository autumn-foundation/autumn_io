+++
title = "Hooks & Transactions"
description = "This guide covers every layer of Autumn's mutation pipeline: database transactions, repository lifecycle hooks, post-commit callbacks, and bulk operations. Each layer has a distinct scope and different error semantics. Understanding how they compose is the key to writing correct, side-effect-safe code."
order = 360
+++
