...
description = "Autumn's version history feature automatically captures an immutable audit trail of every write to opted-in #[repository] models. It answers the question \"who changed this row, when, and to what?\" without any per-call-site instrumentation."
order = 410
+++
