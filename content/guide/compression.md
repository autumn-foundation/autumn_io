...
description = "Autumn provides first-class, configurable response compression via a built-in `CompressionLayer`cl that honors the client's Accept-Encoding header."
order = 310
+++
