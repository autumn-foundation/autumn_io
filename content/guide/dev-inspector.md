+++
title = "Dev Request Inspector"
description = "The Autumn request inspector gives you a real-time view of every HTTP request your application handled — method, path, status, duration, and the SQL queries that fired — without leaving the browser or switching to a log terminal."
order = 660
+++
