+++
title = "Resilience & Outbound Circuit Breakers"
description = "Autumn provides a first-class CircuitBreaker resilience policy for outbound dependencies (HTTP clients, background jobs, and SMTP mailers) to protect the application from cascading failures during downstream outages."
order = 590
+++
