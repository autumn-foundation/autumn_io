...
description = "autumn new <name> scaffolds a minimal base project. A starter instead scaffolds a complete, runnable application archetype — so you reach a working, domain-shaped app in minutes instead of hand-assembling primitives. Starters come in two flavours:"
order = 960
+++
