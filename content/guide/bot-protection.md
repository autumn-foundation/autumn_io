...
description = "Autumn's bot protection middleware validates a CAPTCHA token on every application/x-www-form-urlencoded POST/PUT/PATCH/DELETE request before it reaches a handler. Requests that fail the challenge receive a 400 Bad Request Problem Details response; handlers never see them."
order = 480
+++
