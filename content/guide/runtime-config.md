...
description = "Runtime configuration lets you change operational knobs — rate-limit ceilings, timeouts, retry counts, support email addresses, batch sizes — without a redeploy. Operators set a value once via the CLI or admin UI; all replicas pick it up within seconds."
order = 580
+++
