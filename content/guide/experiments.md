...
description = "Autumn ships a first-party A/B experiment system that handles the hard parts: deterministic bucketing, sticky assignments, and structured exposure telemetry. You declare experiments, start them, and assign actors — the framework emits exposure events that your analytics pipeline can join to outcome data."
order = 570
+++
