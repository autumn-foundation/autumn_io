...
description = "Autumn ships a first-class outbound HTTP client that plugs into the same tracing, configuration, and testing machinery as the rest of the framework. Zero extra dependencies are needed — Client is available whenever you use autumn-web with the default feature set."
order = 530
+++
